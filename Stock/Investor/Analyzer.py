...
class MarketDB:
    def __init__(self):
        ...
        self.codes={}
        self.get_comp_info() # 마리아디비에서 company_info 테이블을 읽어와서 codes에 저장한다.

    def __del__(self):
        """소멸자: MariaDB 연결 해제"""
        # del 객체이름 ==> 명시적으로 객체를 삭제해야 마리아디비와 연결 해제
        self.conn.close()
    ...
    def get_daily_price(self, code, start_date=None, end_date=None):
        ...
        if (start_date is None):
            # 1년 전 오늘 날짜로 yyyy-mm-dd 형식으로 문자열
        ...
        if code in codes_keys:
            ...
            print("ValueErrorL Code({}) doesn't exist.".format(code))
